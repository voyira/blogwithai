        ...
        <div className='py-4 md:px-16 lg:px-24 xl:px-32 bg-primary/3'>
            <div
                ...
                <div>
                    ...
                    <p className='max-w-[410px] mt-6'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Lorem
            ...
            <p className='py-2 text-center text-sm md:text-base text-gray-600'>Copyright 2026 ©️ All
                Right Reserved</p>
        </div>
    );
};
